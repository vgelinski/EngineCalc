...
#include "../../../../src/math/function/polynomial/polynomial.h"
...
TEST (PolynomialTest, common) {
    ...
    ASSERT_STREQ(polynomial->toString().c_str(),  "\\left(\\left(2w^{30}tx^2\\right) + \\left(-3v^3ut^2\\right) + \\left(7z^3yx^2\\right)\\right)");
}
